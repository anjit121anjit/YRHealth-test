					...
					builder.setMessage("Are sure to cancle Appointment")
							.setPositiveButton("Confirm", new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int id) {
									...
									Toast.makeText(MyAppointmentActivity.this, "Confirmed Successfully", Toast.LENGTH_LONG).show();
								}
							})
							.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog, int id) {
									...
									//Toast.makeText(MyAppointmentActivity.this, "Appointment Canceled Successfully", Toast.LENGTH_LONG).show();
								}
							});
